...
Since then, Floe has published dozens of works on varied topics from astronomy and public health to cryptography and zoology, using a wide range of statistical and computational methods including machine learning, system dynamics, and Bayesian statistics for prediction and for inference. His first book, *Folklore and Zoology*, was published by *CRC Press* in 2024. Floe has presented his works internationally at scientific conferences including *HistoCrypt*, the meeting of the *American Astronomical Society*, and the *Society for Research on Nicotine and Tobacco* annual meetings. 
